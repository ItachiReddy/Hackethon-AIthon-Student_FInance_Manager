  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-glow hover:shadow-strong transform hover:scale-105",
        ...
        hero: "bg-gradient-hero text-white hover:opacity-90 shadow-glow hover:shadow-strong transform hover:scale-105 animate-glow-pulse",
      },
      size: {
